...
Action Item:  research off-the-rack forums to see if some or all of the required non-crypto features are available in an off-the-rack forum and cost. We’ll just start with Daedalus and a reddit subforum to display all information (credentials, Intel.   
...
[1.1.19 Status:  We have moved on from Marlowe and Meadow to Plutus.  However, @bobert on the Cardano forums says that it was revealed at Plutusfest that we will eventually be able to translate Marlowe into Plutus.   So the work there will be recoverable via translation.  However, our Plutus skills are improving quickly and it’s likely we will be able to code the same things in Plutus quicker than translation becomes available.]

[12.21.18 Status:  We have an incomplete first draft of a prototype smart contract to run an Intel Bounty.  It was created in Marlowe Meadow.  Thinking of finishing it directly in Plutus.    Much...much….much work is needed here.   But, super glad we have a start.]

1.1.19 Plutus Action Items:
code in curation voting logic...i.e. majority rule
Code on-chain events
Code in curation stake deposit and slashing
Code in blacklist voting logic i.e. majority rule
Code in blacklist staking and slashing, and
Code in intel source, curator, and blacklister payouts and percentages



12.21.18 Old Marlowe Meadow Action Items:   
1) code in curation voting logic in Meadow...i.e. majority rule, 
2) code in Done--Curation Stake deposit and slashing, 
3) code in Blacklist voting (i.e. multiple blacklist voters & majority rule)
4) code in Blacklist staking and slashing, and
5) DONE--code in curator and Intel Source payout percentages.
...
Action Item:  research further case studies of successful ETH game marketing (e.g. Crypto Kitties).

Action Item:  research all available ICO marketing guide materials.

Action Item:  get an early taste of how the marketing copy might go by writing a mock reddit launch announcement post.
...
-Research, discussion, thought, refinement of white paper
-Selected ADA

November 2018:  
-began learning javascript and building out VERY basic javascript for web platform
-researched Cardano to determine how to build smart contract backend and if we need a tech founder to do it.

December 2018:
-Plutus and Marlow are released
-began building smart contracts in Marlowe
-determined that a tech founder may not be necessary
-moved in the direction of Plutus over Marlowe
-decided to house user experience initially in Daedalus and a Reddit subforum and later add mobile dApp and web platform.

January 2018 to June 2019:  
-Work toward MVP based on Plutus running in Daedalus with content in Reddit subforum  

June 2019 - September 2019:  Phase Two of continued development on above, and
carefully planned slow-drip marketing campaign with a focus on community building on Reddit.

October 2019 - Mid-December 2019
Testing, bug bounties, fixes.

Mid-December 2019:  launch prior to holiday break for student adoption over break!


2020-2023
Slowly bootstrap adoption by focusing on community building and cultivation of a reputation as a project group who builds useful things first, second, and third and takes profit last.     

2024:  Go full time at Army of Spies
2025:  Moon Lambos? 
